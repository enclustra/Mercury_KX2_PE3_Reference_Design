# Mercury KX2 PE3 Reference Design
...
## Description
This repository contains the necessary files for creating the Enclustra reference design for all supported Mercury KX2 module variants in combination with the Mercury PE3 base board.
